...
configuration::configuration()
  : log_segment_size(
    *this,
    ...
    {.needs_restart = needs_restart_t::no,
     .example = "2147483648",
  ...
  , topic_memory_per_partition(
      *this,
      ...
      {.needs_restart = needs_restart_t::no, .visibility = visibility_t::tunable},
      1_MiB,
      {
  ...
  , admin_api_require_auth(
      *this,
      ...
      "headers",
      {.needs_restart = needs_restart_t::no, .visibility = visibility_t::user},
      false)
  ...
  , metadata_dissemination_interval_ms(
      *this,
      ...
      {.example = "5000", .visibility = visibility_t::tunable},
      3'000ms)
  ...
  , tm_violation_recovery_policy(
      *this,
      ...
      {.example = "best_effort", .visibility = visibility_t::user},
  ...
  , append_chunk_size(
      *this,
      ...
      {.example = "32768", .visibility = visibility_t::tunable},
      16_KiB,
  ...
  , cloud_storage_secret_key(
      *this,
      "cloud_storage_secret_key",
      "AWS secret key",
      {.visibility = visibility_t::user, .secret = is_secret::yes},
      std::nullopt)
